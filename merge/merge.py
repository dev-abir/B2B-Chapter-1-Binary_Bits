...
# NOTE: another approach could be to combine the two arrays and sort the resultant array, but it will be slower (more time complexity). Huge datasets could cause TLE (Time Limit Exceeded).
